 ...
 * 
 * This function use to insert the agrument value in the queue. If there is free space is available in  * queue
 ...
 *
 * This function use to get the data from queue and return by argument. If there is a data available in * queue
